...
#data file
data = pd.read_excel(r"E:\python\bdata.xlsx")
#feature's array
...
if predlog[0] == 1:     # 1 denotes Malignant type of breast cancer
    print("\nType of Breast cancer : Malignant")
elif predlog[0] == 0:      # 0 denotes Benign type of breast cancer
